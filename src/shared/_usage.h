...
#define longopts_COMMON \
  {"help", 0, NULL, 'h'}, {"nocolor", 0, NULL, 'C'}, {"version", 0, NULL, 'V'}, {"verbose", 0, NULL, 'v'}, {"quiet", 0, NULL, 'q'}, { NULL, 0, NULL, 0 }

#define longopts_help_COMMON \
  "Display this help output", "Disable color output", "Display software version", "Run verbosely", "Run quietly (repeat to suppress errors)"

#define case_RC_COMMON_getopt_case_C setenv("EINFO_COLOR", "NO", 1);
#define case_RC_COMMON_getopt_case_h usage(EXIT_SUCCESS);
#define case_RC_COMMON_getopt_case_V \
  if (argc == 2) show_version();
